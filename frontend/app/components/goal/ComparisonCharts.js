...
const darkLayout = () => ({
  ...
  font: { color: cssVar("--text", "#c7cede") }, margin: { t: 20, r: 10, b: 30, l: 30 },
});
    ...
    <div className="chart-grid">
      <div className="chart-card">
        ...
        <Plot
          ...
          layout={{ ...darkLayout(), height: 220 }} config={{ displayModeBar: false, responsive: true }} style={{ width: "100%" }} />
      </div>
      <div className="chart-card">
        ...
        <Plot
          ...
          layout={{ ...darkLayout(), height: 220, showlegend: true, legend: { orientation: "h", y: 1.15, font: { size: 10 } } }}
