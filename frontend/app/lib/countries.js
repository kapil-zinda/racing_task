// Country dial-code data for the signup phone input.
// Flags are derived from the ISO-3166 alpha-2 code (regional-indicator code
// points) so we don't ship 200 flag glyphs by hand.
...
// { name, iso (alpha-2), dial (no leading +) }
